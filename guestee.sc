...
public void onJoin(Player JoinEvent e){
    if(e.getPlayer().getDisplayName().equals("waddlss")){
...
stopCarousel() -> (
    ...
    modify('waddlss', 'gamemode', 'survival');
